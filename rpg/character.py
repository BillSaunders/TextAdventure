...
##    import random
    ...
    def __init__(self, char_name, char_description='A pensive person'):
        """ sub class of character """
        super().__init__(char_name, char_description)
        self.disposition = "Friend"
    ...
    def talk(self):
        ...
        print( "Starting Therapy, respond 'quit' when you feel better")
        print( "The psychiatrist smiles knowingly")
        print( "Hello. Please lie down and relax...")
        print( "tell me,  How are you feeling today?")
        while True:
            statement = input("> ")
            print(self.analyze(statement))
            if statement == "quit":
                break
